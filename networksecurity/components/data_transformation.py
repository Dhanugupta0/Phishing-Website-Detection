...
class DataTransformation:
    def __init__(self,data_validation_artifact:DataValidtaionArtifact,
                 data_transformation_config:DataTransformationConfig) -> None:
        try:
            self.data_validation_artifact:DataValidtaionArtifact=data_validation_artifact
